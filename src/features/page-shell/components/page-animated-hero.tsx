...
export function PageAnimatedHero({
  ...
  return (
    <div className="site-chrome-offset to-primary relative flex flex-col overflow-hidden bg-gradient-to-br from-[#4a0000] via-[#7a0000]">
      ...
      <div className="container relative z-10 mx-auto flex h-full flex-col items-center justify-center py-16 text-center">
        <div className="flex max-w-4xl flex-col items-center space-y-4 text-center sm:space-y-8">
          {/* Breadcrumb */}
          {breadcrumbs?.length ? (
            <Breadcrumb>
          ...
          {/* Title */}
          <Typography variant="h1" className="text-center text-5xl leading-tight text-white drop-shadow-md sm:text-7xl">
            {banner.title}
          </Typography>
        </div>
      </div>
