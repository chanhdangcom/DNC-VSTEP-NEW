      ...
      <div className="to-primary relative left-1/2 flex h-[720px] w-screen -translate-x-1/2 flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-[#8a0000] via-[#5a0000] sm:h-[620px]">
        ...
        <div className="pointer-events-none absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 select-none">
            <span className="text-[20rem] leading-none font-black tracking-tighter text-white/[0.02] md:text-[30rem] lg:text-[40rem]">
              VSTEP
            </span>
          </div>

          {/* Các đường line chéo (Diagonal slashes) */}
          <div className="absolute -top-[20%] -left-[10%] h-[150%] w-[4px] rotate-[35deg] bg-white/5 blur-[1px]" />
          <div className="absolute -top-[20%] right-[10%] h-[150%] w-[2px] rotate-[35deg] bg-white/5" />
